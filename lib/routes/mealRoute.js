...
// Looks for categories 'like' the parameter
router.get("/category/:category", mealController.categorySearch);
...
// Looks for names 'like' the parameter
router.get("/name/:name", mealController.nameSearch);
// Creates a new meal
