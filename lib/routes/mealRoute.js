...
router.put("/meals/:name", mealController.nameEdit);
// Edits a meal that matches the id parameter
router.put("/meals/:id", mealController.idEdit);
// Deletes a meal that matches the name paramater
router.delete("/meals/:name", mealController.nameDelete);
// Deletes a meal that matches the id parameter
router.delete("/meals/:id", mealController.idDelete);
